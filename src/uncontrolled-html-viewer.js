...
import ReactHTMLPanZoom from './html-viewer'
import PropTypes from "prop-types";
import {TOOL_NONE} from "./constants";

export default class UncontrolledReactHTMLPanZoom extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
...
UncontrolledReactHTMLPanZoom.propTypes = {
